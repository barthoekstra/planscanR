...
test_that("slugify_topic produces stable column-safe suffixes", {
  ...
  expect_identical(planscanR:::slugify_topic("power lines & grid"), "power_lines_grid")
...
test_that("languages_for_country handles multi-language and unknown codes", {
  expect_identical(planscanR:::languages_for_country("nl"), "nl")
  expect_identical(planscanR:::languages_for_country("at"), "de")
  expect_setequal(planscanR:::languages_for_country("be"), c("nl", "fr", "de"))
