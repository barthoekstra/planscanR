...
#' [get_assessments()] or [score_records()].
#'
...
#' have a tibble of records (from [get_assessments()] or [index_cache()]) and
...
#' so [index_cache()] keeps them visible on the next session.
#'
